...
Das Rendering des Spiels ist eine komplexe Angelegenheit, und wir von uns im Laufe unserer Änderungen nicht verändert und als gegeben angesehen. Aufgrund der Komplexität ist es auch nicht vollständig modelliert, soll dennoch hier etwas genauer erklärt werden.

Die Application hat eine Referenz zum sog. RenderMaster, die von der Application zu den jeweiligen Klassen weitergereicht wird, die diesen aufrufen wollen. 
