...
Im Zentrum des Spiels steht die \texttt{World} Klasse. Diese beinhaltet die Blöcke, die in der Welt platziert sind, welche in Chunks unterteilt sind. Sobald eine Welt instanziiert wird, startet ein neuer Thread, der für die Generierung von Chunks verantwortlich ist. Damit kann das Rendern unabhängig von der Generierung vonstatten gehen und die beiden Prozesse stehen sich nicht im Weg. Die Welt initiiert auch das Rendern der Chunks, angesto\ss{}en in regelmäßigen Abständen durch die Anwendung.
