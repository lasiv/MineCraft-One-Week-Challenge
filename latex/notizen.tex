...
\begin{figure}[h]
  ...
  \caption{Designmodellteil: Player}  
\end{figure}
...
\begin{figure}[h]
  \begin{tikzpicture}
    ...
    \umluniassoc[name=Relation0,geometry=|-,anchor1=150.3,anchor2=0.0,mult1={1},pos1=0.2,mult2={*},arg2={events},pos2=1.8]{UMLClass1}{UMLClass3}
    ...
    \umlcompo[name=Relation5,geometry=|-,anchor1=29.7,anchor2=180.0,mult1={1},arg1={world},pos1=0.2,mult2={1},arg2={chunkManager},pos2=1.8]{UMLClass1}{UMLClass4}
    \umlassoc[name=Relation6,geometry=|-,anchor1=-29.7,anchor2=180.0,mult1={1},arg1={pWorld},pos1=0.2,mult2={*},arg2={chunkUpdates},pos2=1.8]{UMLClass1}{UMLClass6}
  ...
  \end{tikzpicture}
  \label{fig:worl_design}
  \caption{Designmodellteil: World}
\end{figure}
...
\begin{figure}[h]
  \begin{tikzpicture}
    ...
    \umlsimpleclass[x=21.60,y=-6.80,alias=UMLClass3]{StructureBuilder}
    \umlsimpleclass[x=21.60,y=-11.80,alias=UMLClass4]{ClassicOverworldGenerator}
    \umlsimpleclass[x=21.50,y=-9.20,alias=UMLClass5]{Biome}
    \umlsimpleclass[x=21.70,y=-14.60,alias=UMLClass6]{NoiseGenerator}
    ...
    \umldep[name=Relation3,geometry=--,anchor1=76.0,anchor2=-90.0]{UMLClass5}{UMLClass3}
    \node[above] at (Relation3-1) {\textless{}\textless{}uses\textgreater{}\textgreater{}};
    \umlcompo[name=Relation4,geometry=--,anchor1=0.0,anchor2=180.0,mult1={*},pos1=0.2,mult2={1},arg2={terrainGenerator},pos2=0.8]{UMLClass2}{UMLClass4}
    \umlcompo[name=Relation5,geometry=--,anchor1=-90.0,anchor2=104.0,mult1={1},pos1=0.2,mult2={1},arg2={biomeNoiseGen},pos2=0.8]{UMLClass4}{UMLClass6}
    \umlcompo[name=Relation6,geometry=--,anchor1=90.0,anchor2=-76.0,mult1={*},pos1=0.2,mult2={5},pos2=0.8]{UMLClass4}{UMLClass5}
    \umlcompo[name=Relation7,geometry=-|-,anchor1=0.0,anchor2=0.0,mult1={1},pos1=0.2,mult2={1},arg2={heightGenerator},pos2=2.8]{UMLClass5}{UMLClass6}
  \end{tikzpicture}
\end{figure}
