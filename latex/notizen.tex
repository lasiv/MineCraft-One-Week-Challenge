...
\newpage
\section{Designmodell} \label{subsec:design}
...
\begin{gfx}{Designmodell States}{states}{ht}
...
\subsection*{Player}
\begin{gfx}{Designmodell Player}{player-design}{ht}
...
\begin{gfx}{Designmodell World}{world}{ht}
...
\begin{gfx}{Designmodell Blöcke}{blocks}{ht}
...
\begin{gfx}{Designmodell Generation der Welt}{genreation}{ht}
...
\begin{gfx}{Designmodell Rendering von Chunks}{render}{ht}
...
\newpage
\section{Modelle gemä\ss{} der Veränderungen}

In diesem Abschnitt werden Modelle um wichtige Klassen oder Beziehungen ergänzt bzw. erklärend verändert.

\subsection{Strukturen und Weltgenerierung}

\begin{gfx}{Verändertes Designmodell Generierung}{newgen}{ht}
\umlsimpleclass[x=15.50,y=-5.80,alias=UMLClass0]{World}
\umlsimpleclass[x=11.60,y=-7.20,alias=UMLClass1]{Chunk}
\umlsimpleclass[x=15.50,y=-8.60,alias=UMLClass2]{ChunkManager}
\umlsimpleclass[x=15.40,y=-11.40,alias=UMLClass3]{ClassicOverworldGenerator}
\umlsimpleclass[x=20.00,y=-11.40,alias=UMLClass4]{Biome}
\umlsimpleclass[x=15.70,y=-13.80,alias=UMLClass5]{NoiseGenerator}
\umlsimpleclass[x=11.40,y=-13.80,alias=UMLClass6]{Structure}
\umluniassoc[name=Relation0,geometry=|-,anchor1=116.6,anchor2=180.0,mult1={1},arg1={pWorld},pos1=0.2,mult2={*},pos2=1.8]{UMLClass1}{UMLClass0}
\umlcompo[name=Relation1,geometry=--,anchor1=-76.0,anchor2=76.0,mult1={1},arg1={world},pos1=0.2,mult2={1},arg2={chunkManager},pos2=0.8]{UMLClass0}{UMLClass2}
\umluniassoc[name=Relation2,geometry=-|,anchor1=180.0,anchor2=-116.6,mult1={1},pos1=0.2,mult2={*},arg2={chunks},pos2=1.8]{UMLClass2}{UMLClass1}
\umlcompo[name=Relation3,geometry=--,anchor1=-76.0,anchor2=63.4,mult1={*},pos1=0.2,mult2={1},arg2={terrainGenerator},pos2=0.8]{UMLClass2}{UMLClass3}
\umlcompo[name=Relation4,geometry=--,anchor1=-63.4,anchor2=104.0,mult1={1},pos1=0.2,mult2={1},arg2={biomeNoiseGen},pos2=0.8]{UMLClass3}{UMLClass5}
\umlcompo[name=Relation5,geometry=--,anchor1=0.0,anchor2=180.0,mult1={*},pos1=0.2,mult2={5},pos2=0.8]{UMLClass3}{UMLClass4}
\umlcompo[name=Relation6,geometry=|-,anchor1=-90.0,anchor2=0.0,mult1={1},pos1=0.2,mult2={1},arg2={heightGenerator},pos2=1.5]{UMLClass4}{UMLClass5}
\umlcompo[name=Relation7,geometry=-|,anchor1=180.0,anchor2=90.0,mult1={1},pos1=0.2,mult2={*},pos2=1.8]{UMLClass3}{UMLClass6}
\end{gfx}
...
\begin{gfx}{Verändertes Designmodell Local Bounding Box}{localaabb}{ht}
...
\subsection{GUI und Inventar} \label{subsec:changeguidia}
...
\subsection*{UC08 – Inventarleiste umschalten}
...
\begin{gfx}{Use-Case Diagramm}{usecase}{ht}
  ...
  \begin{umlsystem}[x=4, y=0]{Minecraft-Klon}
    ...
    \umlusecase[x=0, y=-1.2]{Bewegen (vertikal)}
    \umlusecase[x=0, y=-2.4]{Springen}
    \umlusecase[x=0, y=-3.6]{Flugmodus umschalten}
    \umlusecase[x=0, y=-4.8]{Maussteuerung deaktivieren}
    \umlusecase[x=0, y=-6]{Block abbauen}
    \umlusecase[x=0, y=-7.2]{Block platzieren}
    \umlusecase[x=0, y=-8.4]{Inventarleiste umschalten}
    \umlusecase[x=0, y=-9.6]{Debug-Menü umschalten}
  \end{umlsystem}

  % Akteur
  \umlactor[x=-3, y=-5]{Spieler}
  ...
  \umlassoc{Spieler}{usecase-8}
  \umlassoc{Spieler}{usecase-9}
